      ...
      >
        ...
        >
          <button
            ...
            className="flex items-center justify-center gap-1 bg-red-main body-3-semibold w-[189px] h-[52px] rounded-xl pl-2 py-3 text-white active:bg-red-700  transition-all duration-200"
          >
            Beta 신청하러 가기
